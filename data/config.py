from models.backbone import ResNetBackbone, VGGBackbone, ResNetBackboneGN, DarkNetBackbone
...
csgo_dataset = Config({
    ...
    'train_info': './dataset/train/annotations.json',

    'valid_images': './dataset/val/',
    'valid_info': './dataset/val/annotations.json',
    
    'has_gt': True,

    'class_names': ['Pointer', 'Reading'],
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    'dataset': csgo_dataset,
    'num_classes': len(csgo_dataset.class_names) + 1,
