...
Moreover, instead of using HSV color filtering to obtain the pointer mask - which could proved unreliable during different lighting conditions - the latest approach uses a custom trained [YOLACT](https://github.com/dbolya/yolact) to perform instance segmentation to extract the target mask.
