...
class CustomNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.hr_net = HRNet(48, 17, 0.1)
        
        checkpoint = torch.load('./models/pose_hrnet_w48_384x288.pth')
        
        self.hr_net.load_state_dict(checkpoint)
        
        self.hr_net.final_layer = nn.Conv2d(48, 3, kernel_size=(1, 1), stride=(1, 1))

        print('Model Loaded ...\n')
    
    def forward(self, input):

        heatmaps = self.hr_net(input)
